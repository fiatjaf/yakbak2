import { Badge, Hash, Mic, MicOff, Pause, Play, Trash2 } from "lucide-solid"
...
import { formatTime, parseHashtags } from "./utils"
            ...
            {previewUrl && (
              <>
                ...
                <Button
                  ...
                  size="lg"
                  class={`w-16 h-16 rounded-[50%] shadow-lg transition-transform duration-200 flex items-center justify-center p-0 ${
                ...
                >
                  {isRecording ? (
                    <div class="flex flex-col items-center">
                      ...
                      <span class="text-xs mt-1">{formatTime(recordingTime())}</span>
                    </div>
                  ) : previewUrl ? (
                    isPlaying ? (
                      <Pause class="h-6 w-6" />
            ...
            {!previewUrl() ? (
              ...
              <div class="space-y-4">
                ...
                <div class="flex space-x-2">
                  <Button onClick={handlePublishRecording} class="flex-1">
                    <Play class="mr-2 h-4 w-4" />
                    Publish
                  </Button>
                  <Button onClick={handleDiscardRecording} variant="destructive" class="flex-1">
