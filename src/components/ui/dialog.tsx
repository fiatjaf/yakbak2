...
const DialogContent = <T extends ValidComponent = "div">(
  ...
  return (
    <DialogPortal>
      ...
      >
        {props.children}
        <DialogPrimitive.CloseButton class="cursor-pointer absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[expanded]:bg-accent data-[expanded]:text-muted-foreground">
          <svg
